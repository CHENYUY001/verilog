...
#
# Generated by export_simulation on Thu Aug 29 15:20:20 +0800 2024
#
################################################################################
...
'-reset_run' switch to the './block_ram.sh' script.

./block_ram.sh -reset_run
...
./block_ram.sh -noclean_files

For more information on the script, please type './block_ram.sh -help'.
