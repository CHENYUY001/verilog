...
HD_PWD='E:/code/verilog/lab3/regfile_ram/project_1/project_1.runs/block_ram_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log block_ram.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source block_ram.tcl
