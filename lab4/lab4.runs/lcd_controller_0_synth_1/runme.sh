...
HD_PWD='E:/code/verilog/lab4/lab4.runs/lcd_controller_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log lcd_controller_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source lcd_controller_0.tcl
